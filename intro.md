...
For the backend language, I use python/Java, For the framework,  I use Django/Flask and Spring boot.  
 ...
 In the machine learning task: I work on depresion/axniety detection through patient audio, emotional detection through video. sentiment analysis through transcription. 
